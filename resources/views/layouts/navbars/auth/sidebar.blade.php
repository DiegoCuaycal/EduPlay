<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link d-flex align-items-center {{ Request::is('profile/profile') ? 'active bg-primary text-white' : 'text-dark' }}"
      href="{{ url('profile/profile') }}">
      <div class="icon icon-shape icon-sm shadow border-radius-md d-flex align-items-center justify-content-center 
      {{ Request::is('profile/profile') ? 'bg-primary text-white' : 'bg-white text-dark' }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
  ...
  @endif
    ...
    <li class="nav-item">
      <a class="nav-link {{ (Request::is('pruebas-realizadas') ? 'active' : '') }}"
      href="{{ url('pruebas-realizadas') }}">
      <div
        class="icon icon-shape icon-sm shadow border-radius-md {{ Request::is('pruebas-realizadas') ? 'bg-primary text-white' : 'bg-white text-dark' }} text-center me-2 d-flex align-items-center justify-content-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        class="bi bi-clipboard-check" viewBox="0 0 16 16">
        <path fill-rule="evenodd"
          d="M10.854 8.354a.5.5 0 0 0-.708-.708L8 9.793l-1.146-1.147a.5.5 0 0 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l2-2z" />
        <path
          d="M4.5 1a1 1 0 0 0-1 1v1h-1A1.5 1.5 0 0 0 1 4.5v10A1.5 1.5 0 0 0 2.5 16h11a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 13.5 3h-1V2a1 1 0 0 0-1-1h-7zm1 1h5v1h-5V2zm9 3H2.5a.5.5 0 0 1-.5-.5V4.5a.5.5 0 0 1 .5-.5H4v1h8V4h1.5a.5.5 0 0 1 .5.5V5z" />
        </svg>
      </div>
