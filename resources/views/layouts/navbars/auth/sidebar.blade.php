...
document.getElementById('inicio-link').addEventListener('click', function (e) {
  ...
  @endif
    ...
    <li class="nav-item pb-2">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('pruebas_realizadas') ? 'active' : '') }}" href="{{ url('pruebas-realizadas') }}">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="100%" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <span class="nav-link-text ms-1">Pruebas Realizadas</span>
        </a>
      </li>
      ...
      <div
        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        <svg width="12px" height="100%" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink">
