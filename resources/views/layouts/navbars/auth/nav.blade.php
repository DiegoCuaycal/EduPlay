        ...
        <div class="d-flex justify-content-between w-100">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark active text-capitalize">
            ...
            <ul class="navbar-nav d-flex align-items-center ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item me-3">
                    <a class="nav-link dropdown-toggle d-flex align-items-center text-white" href="#" id="jugarDropdown"
                            ...
                            <form action="{{ route('tuRuta') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="gameUrl" name="gameUrl"
                                        placeholder="Ingrese URL del juego" required>
                                    @error('gameUrl')
                ...
                <!-- Menú de Perfil -->
                <li class="nav-item me-3">
                    <a class="nav-link dropdown-toggle d-flex align-items-center text-body" href="#" id="navbarDropdown"
                        role="button" data-bs-toggle="dropdown">
                        <i class="fa fa-user me-1"></i> Perfil
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('user-profile') }}">Configuración del perfil</a>
                        </li>
