      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Utilice estos fantásticos formularios para iniciar sesión o crear una nueva cuenta en su proyecto de forma gratuita.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left">
                ...
                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Inscribirse</button>
                </div>
                <p class="text-sm mt-3 mb-0">Ya tengo una cuenta? <a href="javascript:;" class="text-dark font-weight-bolder">Iniciar sesión</a></p>
              </form>
            </div>
          </div>
        </div>
