...
return [
    ...
    "attributes" => [
        ...
        "innova_id" => "id del trámite",
        "employee_id" => "id del funcionario",
        "state_id" => "id del estado",
        "type_pro_id" => "tipo del trámite",
        "municipality_id" => "id del municipio",
        "municipality_date" => "fecha del municipio",
        "group_id" => "id del grupo",
        "procedure_date" => "fecha del trámite",
        "rec_dni" => "cédula o RUC",
        "rec_num" => "número de factura",
        "rec_names" => "nombres",
        "rec_lastnames" => "apellidos",
        "rec_date" => "fecha de factura",
        "con_names" => "nombres del contacto",
        "con_lastnames" => "apellidos del contacto",
        "con_phone" => "teléfono del contacto",
        "con_email" => "email del contacto",
        "action_id" => "acción",
        "action_name" => "nombre de la acción",
        "det_req_id" => "id del detalle de requerimiento",
        "req_id" => "id del requerimiento",
        "det_req_state" => "estado de la acción",
        "det_req_link" => "enlace del requerimiento",
        "document_id" => "id del documento",
        "document_link" => "enlace del recurso",
        "document_description" => "descripcion del documento",
        ...
        "inspection_observation" => "descripción de la inspección",
        "inspection_status" => "estado de la inspección",
        "person_id" => "id de la persona",
        "name" => "nombre de la persona",
        "req_name" => "nombre del requerimiento",
        "req_description" => "descripción del requerimiento",
        "state_name" => "nombre del estado",
        "state_description" => "descripción del estado",
        "step_id" => "id de la etapa",
        "step_date" => "fecha de la etapa",
        "origin_user" => "usuario de origen",
        "des_user" => "usuario de destino",
        "des_department" => "departamento de destino",
        "origin_department" => "departamento de origen",
        "observation" => "observación de la etapa",
        "project_id" => "proyecto ",
        "type_pro_name" => "nombre del tipo de trámite",
        "type_pro_description" => "descripción del tipo de trámite",
